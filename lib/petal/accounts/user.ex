defmodule Petal.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Petal.Repo)
  ...
  """
  def valid_password?(%Petal.Accounts.User{hashed_password: hashed_password}, password)
